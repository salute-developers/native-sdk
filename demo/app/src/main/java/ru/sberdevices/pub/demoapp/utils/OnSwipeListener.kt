...
/**
 * Helper that allows us to catch screen swipes from touch events.
 *
 * Usually, it is used with androidx.core.view.GestureDetectorCompat.
 *
 * Taken from [StackOverflow](https://stackoverflow.com/a/26387629/4414657)
 */
class OnSwipeListener(
    ...
    enum class SwipeDirection {
        ...
        companion object {
             ...
             */
            fun fromAngle(angle: Double): SwipeDirection = when {
